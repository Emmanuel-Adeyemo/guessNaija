...
def play_one_round(players):
    ...
    while not end:
        ...
        if wheel_prize['type'] == 'bankrupt' and player.money_won > 0:
            ...
            time.sleep(1)
            print(wheel_prize['text'])
            print(f'New total is: ₦{player.money_won * 0.3:,.2f}')
            ...
            time.sleep(1)
            print(wheel_prize['text'])
            print(f'Your money is still at: ₦{player.money_won:,.2f}')
            pass
            ...
            if move == 'EXIT':
                ...
                if letter_count > 0:
                    ...
                    if move in VOWELS:
                        print(f'You spent ₦{VOWEL_COST:,.2f} to guess a vowel.\n')
                        player.money_won -= VOWEL_COST
                        print(f"You won ₦{letter_count * wheel_prize['value']:,.2f\n} from this round.")
                    ...
                    print(f'Running total is still: ₦{player.money_won:,.2f}')
                    time.sleep(2)
                ...
                if move == phrase: # they guessed the full phrase correctly
                    ...
                    print(f'Running total for {player.name} is still: ₦{player.money_won:,.2f}')
                    time.sleep(2)
    ...
    if end:
        ...
        for player in players:
            print(f'{player.name} won a total of: ₦{player.money_won:,.2f}\n')
        ...
        time.sleep(2)
        print(f'{winner.name} won ₦{winner.money_won:,.2f}')
        time.sleep(2)
...
if __name__ == '__main__':
    ...
    game_on = True
    while game_on:
        game_on = not play_one_round(players)
